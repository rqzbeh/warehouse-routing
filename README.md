...
`ponytail:` فعلا امتیازدهی وزن‌دار قطعی کافی است، چون ورودی چالش گراف واقعی جاده‌ای ندارد. وقتی داده یال‌های مسیر و زمان واقعی بین نقاط اضافه شد، ارتقا به Dijkstra یا A* معنی دارد.
